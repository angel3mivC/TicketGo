...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchSummary = fetch(
      "https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/dashboard/summary",
      {
        method: "GET",
        headers: {
    ...
    const fetchTecnicos = fetch(
      "https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/dashboard/tecnicos/total",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  useEffect(() => {
    ...
    const fetchActivos = fetch(
      "https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/dashboard/tecnicos/activos",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    const fetchInactivos = fetch(
      "https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/dashboard/tecnicos/inactivos",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    Promise.all([fetchActivos, fetchInactivos])
      ...
      .catch((err) =>
        console.error("Error al obtener técnicos activos/inactivos:", err)
      );
  }, [refresh]);
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dashboard-graficas">
        <CardNuevosTickets />
        <TecnicosCard
          activos={tecnicosData.activos}
          inactivos={tecnicosData.inactivos}
        />
      </div>
