...
const CrearUsuario = () => {
  ...
  const crearUsuario = (e) => {
    ...
    fetch(`https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/users`, {
      method: "POST",
      headers: {
  ...
  return (
    <div className="form-create-user">
      ...
      <form className="form-create" ref={formulario}>
        ...
        <button type="submit" className="create-button" onClick={crearUsuario}>
          Crear
        </button>
      </form>
    </div>
