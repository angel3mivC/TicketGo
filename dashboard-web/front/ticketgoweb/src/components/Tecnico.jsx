...
const Tecnico = () => {
  ...
  useEffect(() => {
    ...
    if (activeTab === "tickets")
      url = `https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/tickets?tecnico=${id_usuario}`;
    else if (activeTab === "historial")
      url = `https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/tickets/?tecnico=${id_usuario}&estado=Cerrado`;
    ...
    if (sinFiltros) {
      ...
      const filtrados = tickets.filter((ticket) => {
        ...
        const cumpleCategoria =
          !filtros.categoria || ticket.categoria === filtros.categoria;
          ...
          <div className="textsAreaTickets">
            <div>
              ...
              <div className="subtitle">
                Consulta todos los tickets asignados.
              </div>
            </div>
