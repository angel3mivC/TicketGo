...
const EditarUsuario = ({ usuario, onClose, onSuccess }) => {
  ...
  const editarUsuario = (e) => {
    ...
    fetch(
      `https://e3ljh2zo7k.execute-api.us-east-1.amazonaws.com/users/${usuario.id_usuario}`,
      {
        method: "PUT",
        headers: {
  ...
  return (
    <div className="form-edit-user">
      ...
      <form className="form-edit" ref={formulario}>
        ...
        <button type="submit" className="edit-button" onClick={editarUsuario}>
          Guardar Cambios
        </button>
      </form>
    </div>
